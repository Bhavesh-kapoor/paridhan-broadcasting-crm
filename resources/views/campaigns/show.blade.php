                            ...
                            <div class="col-md-6">
                                ...
                                <p class="mb-3">
                                    <span class="badge {{ $campaign->status_badge_class }} px-3 py-2">
                                        <i
                                            class="ph ph-{{ $campaign->status === 'draft' ? 'file-text' : ($campaign->status === 'sent' ? 'check-circle' : 'clock') }} me-1"></i>
                                ...
                                <tbody>
                                    @forelse($campaign->recipients as $recipient)
                                        <tr class="border-bottom">
                                            <td class="px-3 py-3">
                                                <h6 class="mb-1 fw-semibold text-dark">{{ $recipient->contact->name }}
                                                </h6>
                                            </td>
                                            <td class="px-3 py-3">
                                            ...
                                            <td class="px-3 py-3">
                                                <span class="badge bg-light text-dark px-3 py-2 border">
                                                    <i
                                                        class="ph ph-{{ $recipient->contact->type === 'exhibitor' ? 'storefront' : 'user' }} me-1"></i>
                                            ...
                                            <td class="px-3 py-3">
                                                ...
                                                <span class="badge {{ $statusClass }} px-3 py-2">
                                                    <i
                                                        class="ph ph-{{ $recipient->status === 'pending' ? 'clock' : ($recipient->status === 'sent' ? 'check-circle' : ($recipient->status === 'delivered' ? 'check-circle' : 'x-circle')) }} me-1"></i>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow">
                ...
                <div class="modal-body p-4">
                    ...
                    <p class="text-center text-muted mb-0">This action cannot be undone. The campaign will be permanently
