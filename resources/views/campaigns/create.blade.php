                            ...
                            <div class="row g-3" style="padding: 10px;">
                                ...
                                <div class="col-12">
                                    <label class="form-label fw-semibold text-dark mb-2">
                                        <i class="ph ph-tag me-2 text-muted"></i>&nbsp;Campaign Name <span
                                ...
                                <div class="col-12">
                                    <label class="form-label fw-semibold text-dark mb-2">
                                        <i class="ph ph-envelope me-2 text-muted"></i>&nbsp;Campaign Subject <span
                                            class="text-danger">*</span>
                                    </label>
                                ...
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold text-dark mb-2">
                                        <i class="ph ph-tag me-2 text-muted"></i>&nbsp;Campaign Type <span
                                            class="text-danger">*</span>
                                    </label>
                                ...
                                <div class="col-12">
                                    <label class="form-label fw-semibold text-dark mb-2">
                                        <i class="ph ph-chat-circle-text me-2 text-muted">&nbsp;</i>Campaign Message <span
                                            class="text-danger">*</span>
                                    </label>
                ...
                <div class="col-lg-4">
                    <div class="card border-0 shadow-sm mb-4">
                        ...
                        <div class="card-body p-4">
                            ...
                            <!-- Tab Content -->
                            <div class="tab-content" id="recipientTabsContent" style="padding: 10px;">
                                <!-- Exhibitors Tab -->
                                            ...
                                            @forelse($exhibitors as $exhibitor)
                                                <div class="form-check mb-2">
                                                    ...
                                                    <label class="form-check-label small"
                                                        for="exhibitor_{{ $exhibitor->id }}">
                                                        <div class="d-flex flex-column">
                                                            <span class="fw-semibold">{{ $exhibitor->name }}</span>
                                                            <small class="text-muted">{{ $exhibitor->email }} •
                                        ...
                                        <div class="recipient-list" style="max-height: 300px; overflow-y: auto;">
                                            @forelse($visitors as $visitor)
                                                <div class="form-check mb-2">
                                                    ...
                                                    <label class="form-check-label small"
                                                        for="visitor_{{ $visitor->id }}">
                                                        <div class="d-flex flex-column">
                                                            <span class="fw-semibold">{{ $visitor->name }}</span>
                                                            <small class="text-muted">{{ $visitor->phone }} •
                                                                {{ $visitor->location }}</small>
                                                        </div>
                                                    </label>
                                                </div>
                                            @empty
