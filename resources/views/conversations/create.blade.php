                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Create Conversation</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="card border-0 shadow-sm">
                        <div class="card-header bg-light border-0 py-3">
                            <h6 class="mb-0 fw-semibold text-dark">
                                <i class="bx bx-plus-circle me-2 text-primary"></i>Create New Conversation
                            </h6>
                        </div>
                        <div class="card-body">
                                    ...
                                    <div class="col-12">
                                        <div class="card border-0 shadow-sm mb-3" style="background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%);">
                                            <div class="card-body p-3">
                                                ...
                                                <textarea name="notes" id="notes" class="form-control" rows="4" placeholder="Enter conversation notes/comments..."></textarea>
                                            </div>
                                        </div>
                                    </div>
</div>
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <button type="submit" class="btn btn-primary">
                                                <i class="bx bx-check-circle me-1"></i>Create Conversation
                                            </button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        success: function(response) {
                            if (Array.isArray(response) && response.length > 0) {
                                response.forEach(function(table) {
                                    tableSelect.append(`<option value="${table.id}">${table.table_no} (₹${table.price || 0})</option>`);
                                });
                            }
                        },
                        error: function() {
