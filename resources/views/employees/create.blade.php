            ...
            <div class="card shadow-sm">
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center" style="margin-left: 20px;">
                        <div>
                            <h5 class="mb-1 fw-bold text-dark"> Add New Employee</h5>
                            <p class="text-muted mb-0">Create a new team member account</p>
                        </div>
                        <a href="{{ route('employees.index') }}" class="py-12 text-15 px-20 hover-bg-gray-50 text-gray-300 rounded-8 flex-align gap-8 fw-medium text-15">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3" style="margin-top: 10px;">
                                                <label for="password" class="form-label fw-semibold">
                                                    <i class="ph ph-lock me-2 text-muted"></i>&nbsp;Password <span
                                                        class="text-danger">*</span>
                                                </label>
                                                ...
                                                <small class="form-text text-muted">
                                                    <i class="ph ph-info me-1"></i>&nbsp;Password must be at least 8
                                                    characters long.
                                                </small>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3" style="margin-top: 10px;">
                                                <label for="password_confirmation" class="form-label fw-semibold">
                                                    <i class="ph ph-lock-key me-2 text-muted"></i>&nbsp;Confirm Password
