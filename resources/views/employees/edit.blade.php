                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3" style="margin-top: 10px;">
                                            ...
                                            <small class="form-text text-muted">
                                                <i class="ph ph-info me-1"></i>&nbsp;Leave blank to keep current password. Must be at least 8 characters if changed.
                                            </small>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3" style="margin-top: 10px;">
                                            <label for="password_confirmation" class="form-label fw-semibold">
                                                <i class="ph ph-lock-key me-2 text-muted"></i>&nbsp;Confirm New Password
                                            </label>
                                            <div class="input-group">
