...
<body>
    ...
    <section class="auth d-flex">
        <div class="auth-left bg-main-50 flex-center p-24 ">
            <img src="{{ asset('assets/logo/banner.jpeg') }}" style="width: 900px; height:700px;object-fit:contain"
                alt="">
                ...
                <form action="{{ route('login.validate') }}" method="post" id="loginform">
                    ...
                    <div class="mb-32 flex-between flex-wrap gap-8">
                        <div class="form-check mb-0 flex-shrink-0">
                            <input class="form-check-input flex-shrink-0 rounded-4" value="1" name="remember"
