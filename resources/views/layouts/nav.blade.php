...
<div class="sidebar-wrapper" data-simplebar="true">
    ...
    <ul class="metismenu" id="menu">
        ...
        @endif
        {{-- <li>
         p   <a href="javascript:;" class="has-arrow">
                <div class="parent-icon"><i class="lni lni-users"></i>
                </div>
                <div class="menu-title">Employees</div>
            </a>
            <ul>
                <li> <a href="{{ route('employees.index') }}"><i class='bx bx-radio-circle'></i>All Employees</a>
                </li>
                <li> <a href="app-chat-box.html"><i class='bx bx-radio-circle'></i>Active Employees</a>
                </li>
                <li> <a href="app-file-manager.html"><i class='bx bx-radio-circle'></i>Inactive Employees</a>
                </li>
                <li> <a href="app-contact-list.html"><i class='bx bx-radio-circle'></i>Add Employee</a>
                </li>
            </ul>
        </li> --}}
