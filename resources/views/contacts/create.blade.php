                ...
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center" style="margin-left: 20px;">
                        <div>
                            ...
                            <p class="text-muted mb-0">Add new {{ $type }} information to the system</p>
                        </div>
                                ...
                                <div class="p-3">
                                    ...
                                    <div class="mb-3" style="margin-top: 10px;">
                                        <label for="location" class="form-label fw-semibold">
                                            <i class="ph ph-map-pin me-2 text-muted"></i>&nbsp;Location <span
                                                class="text-danger">*</span>
                                        </label>
                                ...
                                <div class="p-3">
                                    ...
                                    <div class="mb-3" style="margin-top: 10px;">
                                        <label for="phone" class="form-label fw-semibold">
                                            <i class="ph ph-phone me-2 text-muted"></i>&nbsp;Phone Number <span
                                                class="text-danger">*</span>
                                        </label>
                                    ...
                                    @if ($type === 'exhibitor')
                                        <div class="mb-3" style="margin-top: 10px;">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('alternate_phone') }}" placeholder="Enter alternate phone">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3" style="margin-top: 10px;">
                                                    <label for="email" class="form-label fw-semibold">
                                                        <i class="ph ph-envelope me-2 text-muted"></i>&nbsp;Email Address
                                                ...
                                                <div class="mb-3" style="margin-top: 10px;">
                                                    ...
                                                    <select
                                                        ...
                                                        <option value="Manufacturer"
                                                            {{ old('business_type') == 'Manufacturer' ? 'selected' : '' }}>
                                                            Manufacturer</option>
                                                        <option value="Distributor"
                                                            {{ old('business_type') == 'Distributor' ? 'selected' : '' }}>
                                                            Distributor</option>
                                                        <option value="Retailer"
                                                            {{ old('business_type') == 'Retailer' ? 'selected' : '' }}>
                                                            Retailer</option>
                                                        <option value="Wholesaler"
                                                            {{ old('business_type') == 'Wholesaler' ? 'selected' : '' }}>
                                                            Wholesaler</option>
                                                        <option value="Service Provider"
                                                            {{ old('business_type') == 'Service Provider' ? 'selected' : '' }}>
                        ...
                        <div class="row  mt-4 mb-5">
                            <div class="col-12">
                                <div class="d-flex justify-content-between align-items-center  mx-12">
                                    <button type="submit"
                                        class="btn btn-{{ $type === 'exhibitor' ? 'primary' : 'success' }} btn-sm shadow-sm"
                                        id="submitBtn">
                                        <i class="ph ph-check-circle me-2"></i>&nbsp;Save {{ ucfirst($type) }}
                                    </button>
                                    <a href="{{ route('contacts.index', ['type' => $type]) }}"
...
@push('scripts')
    <script>
        ...
        $('#contactForm').on('submit', function(e) {
            ...
            submitBtn.html('<i class="ph ph-spinner ph-spin me-2"></i>&nbsp;Saving...');
