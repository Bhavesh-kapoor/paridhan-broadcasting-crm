        ...
        <div class="card shadow-sm">
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-center" style="margin-left: 20px;">
                    ...
                    <a href="{{ route('contacts.index', ['type' => $type]) }}" class="btn btn-outline-secondary">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3" style="margin-top: 10px;">
                                            ...
                                            <input type="text" class="form-control @error('product_type') is-invalid @enderror" 
                                                   id="product_type" name="product_type" value="{{ old('product_type') }}" 
                    ...
                    <div class="row mt-4 mb-3" style="margin-left: 10px;">
                        <div class="col-12">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <a href="{{ route('contacts.index', ['type' => $type]) }}" class="btn btn-outline-secondary btn-sm">
